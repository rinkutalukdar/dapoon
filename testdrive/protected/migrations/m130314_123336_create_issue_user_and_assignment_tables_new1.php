...
class m130314_123336_create_issue_user_and_assignment_tables_new1 extends CDbMigration
{
	public function up()
	{
	...
	{
		echo "m130314_123336_create_issue_user_and_assignment_tables_new1 does not support migration down.\n";
		return false;
	}
